                ...
                <div class="col-xs-12 padd-lr0">
                    <ul class="steps">
                        <li class="title-wrap active" data-toggle="collapse" href="#reservation1" aria-expanded="false" aria-controls="reservation1">
                            <div class="title">
                                <span>1.</span>Duyệt yêu cầu
                            </div>
                        </li>
                        <li class="title-wrap ">
                            <div class="title">
                                <span>2.</span>Thanh toán cọc
                            </div>
                        </li>
                        <li class="title-wrap ">
                            <div class="title">
                                <span>3.</span>Khởi hành
                            </div>
                        </li>
                        <li class="title-wrap ">
                            <div class="title">
                                <span>4.</span>Kết thúc
                            </div>
                        </li>
                    </ul>
                </div>
                        ...
                        <form action="#">
                            <div class="modal-body">
                                    ...
                                    <div  class="col-md-5">
                                        <div class="row">
                                            <div class="card profile" style="width: 23rem;">
                                                <div class="card-body">
                                                    <img src="{{ asset('storage/uploads/profile/'. $checkout->car->user->avatar) }}" alt="{{$checkout->car->user->user_name}}">
                                                    <h5 class="card-title">{{$checkout->car->user->user_name}}</h5>
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="mt-2">Sơn Trà, Đà Nẵng, Việt Nam (địa chỉ cụ thể sẽ được hiển thị sau khi đặt cọc).</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary" role="button" id="btnRejectTripContinue">Tiếp tục</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modalSelectReasonRejectTrip" tabindex="-1" role="dialog" aria-labelledby="modalConfirmViewDetailCheckout" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary"  role="button" id="btnRejectTrip">Hủy chuyên</a>
                </div>
            </div>
        </div>
    </div>
